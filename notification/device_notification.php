...
<?php
    include('../connect.php');
    $d_id=$_SESSION['d_id'];
    $count_query=$db->prepare("select notification_id, notification, device_name, notification_time from notification_mst where d_id='$d_id' and see='0'");
    $count_query->execute();
    ...
    <li class="dropdown">
                ...
                <li class="body">
                    <ul class="menu">
                        <?php
                            ...
                            $query=$db->prepare("select notification_id, notification, device_name, notification_time from notification_mst where d_id='$d_id' and see='1' order by notification_id DESC LIMIT 5");
                            $query->execute();
                            if($data=$query->fetch())
                            {
        ...
        <script type="text/javascript">
            $(document).on('click', '#notice_alert', function () 
            {
                ...
                ({
                    type: "POST",
                    url: "../notification/device_notification_hide.php",
