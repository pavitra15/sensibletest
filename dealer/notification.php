...
<?php
    ...
    $count_query=$db->prepare("select notification_id, notification, notification_time from dealer_notification_mst where user_id='$id' and see='0'");
    $count_query->execute();
    ...
    <li class="dropdown">
                ...
                <li class="body">
                    <ul class="menu">
                        <?php
                            ...
                            $query=$db->prepare("select notification_id, notification,  notification_time from dealer_notification_mst where user_id='$id' and see='1' order by notification_id DESC LIMIT 5");
                            $query->execute();
                            if($data=$query->fetch())
                            {
        ...
        <script type="text/javascript">
            $(document).on('click', '#notice_alert', function () 
            {
                ...
                ({
                    type: "POST",
                    url: "notification_hide.php",
                    data:'user_id='+<?php echo $_SESSION['dealer_id']; ?>,
