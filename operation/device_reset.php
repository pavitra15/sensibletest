...
<?php
    ...
    if(isset($_POST['generate_otp']))
    {
        ...
        $_SESSION['terms']=1;
        $_SESSION['flag']=9;
        echo '<script >window.location="../operation/reset_otp";</script>'; 
    }
?>
                    ...
                    <div class="card">
                        <div class="body">
                            <form method="post">
                                <section>
                                    <p>
                                       By resetting device you can lose all device configuration setting and data. if you want to reset only configuration choose configuration setting option only. if you want to delete all category, products, user, and configuration then select all option. please verify your mobile OTP and email OTP before reset device, its mandatory.
                                    </p>
                                </section>
                            </br>
                                <fieldset>
                                ...
                                <button class="btn btn-primary waves-effect" name="generate_otp" type="submit" id="generate_otp" disabled='disabled'>Generate OTP</button>
                            </form>
                        </div>
                    </div>
                </div>
