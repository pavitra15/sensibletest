    ...
    <table class="table table-striped" id="mainTable">
        ...
        <tbody id="tab_id">
            <?php
                ...
                $status="active";
                    $search=$_POST['search'];
                $query=$db->prepare("select product.product_id, english_name,regional_name, weighing,category_id,bucket_id,kitchen_id, comission from product,price_mst, stock_mst where status='$status' and deviceid='$d_id' and product.product_id = price_mst.product_id and product.product_id=stock_mst.product_id and product.english_name LIKE '$search%' ");
                $query->execute();
