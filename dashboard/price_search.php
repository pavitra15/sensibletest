...
(min-device-width: 768px) and (max-device-width: 1024px)  {
    ...
    <table class="table table-striped">
                                    ...
                                    <?php
                                        ...
                                        $status="active";
                                        $search=$_POST['search'];
                                        $query=$db->prepare("select * from product,price_mst, stock_mst where price_mst.product_id=product.product_id and product.status='$status' and product.deviceid='$d_id' and product.product_id=stock_mst.product_id and product.english_name LIKE '$search%'");
                                        $query->execute();
                                                ...
                                                <td>'.$data['english_name'].'</td>
                                                 <td><select class="form-cotrol tax" id="tax'.$data['price_id'].'">
                                                    ...
                                                    for($j=1; $j<=$k; $j++)
                                                    {
                                                        ...
                                                        echo'<td style="max-width:20px"><input type="text" min="0" value="'.$data[$price_name].'"  id="'.$id.'" class="grpprice" style="max-width:70px" /><br><input type="text" min="0" value="'.$data[$price].'"  id="'.$idc.'" class="grpprice1" style="max-width:70px" readonly/></td>';
