        ...
        $('#add').click(function()
         {
            ...
            {
                showNotification("alert-danger","Maximum five premises are allowed", "top", "center",'animated fadeInDown', 'animated fadeOutUp');
            }
        });
                    ...
                    success:function(data){
                        ...
                        switch(ch)
                        {
                            case "1":
                                ...
                                setTimeout("window.location.replace('../cumulative/waiter');",2000);
                            break;
                            case "2":
