		...
		if(json_validator($json))
		{
            ...
            for($m=0; $m<$length; $m++)
            {
				...
				if(in_array($english_name, $exists_arr))
                {
		            ...
		            {
		            	$query=$db->prepare("update product set english_name='$english_name', regional_name='$regional_name', barcode='$barcode', weighing='$weightable', category_id='$category_id', kitchen_id='$kitchen_id', updated_by_date='$created_by_date', updated_by_id='$id' where product_id='$product_id'");
                		$query->execute();
						...
						$stock_query=$db->prepare("update stock_mst set stockable='$stockable', unit_id='$unit_id' where product_id='$product_id'");
						$stock_query->execute();
                ...
                else
                {
					...
					$stock_query=$db->prepare("update stock_mst set stockable='$stockable', unit_id='$unit' where product_id='$product_id'");
					$stock_query->execute();
