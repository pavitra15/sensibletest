...
<?php
    ...
    $count_query=$db->prepare("select notification_id, notification, notification_time from admin_notification where see=0");
    $count_query->execute();
                ...
                <li class="body">
                    <ul class="menu">
                        <?php
                            ...
                            $query=$db->prepare("select notification_id, notification, notification_time from admin_notification where see='1' order by notification_id DESC LIMIT 5");
                            $query->execute();
                            if($data=$query->fetch())
                            {
