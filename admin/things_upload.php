    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <form action="../admin/things_upload_apk.php" id="frmFileUpload" class="dropzone" method="post" enctype="multipart/form-data">
                    <div class="card">
                        <?php
                    ...
                    <div class="col-md-4">
                        <div class="input-group input-group-lg">
                            <?php
                                        $version_query=$db->prepare("select version from apk where apk_id=2");
