...
<?php
    session_start();
    include('../connect.php');
    include('out_of_stock_excel.php');
    $limit=10;
    ...
    $Product_query=$db->prepare("select * from product,category_dtl,stock_mst,price_mst where stock_mst.product_id=product.product_id  and product.deviceid='$d_id' and product.product_id= price_mst.product_id and product.product_id=stock_mst.product_id and product.category_id= category_dtl.category_id and stock_mst.stockable='Yes' and stock_mst.current_stock=0 LIMIT $start_from, $limit");  
    $Product_query->execute();
    ?>
    <!DOCTYPE html>
    <html>
