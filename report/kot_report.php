            ...
            <div class="row clearfix">
                <div class="card">
                    <div class="body table-responsive">
                        <div class="row clearfix">                
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="date_display">
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-2">
                                    <div class="button-demo">
                                        <input type="submit" id="generate" class="btn btn-info waves-effect m-r-20" data-toggle="modal" >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" id="data-display" style="display: none">
                    
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" id="detail-display" style="display: none">
