<?php
    ...
    $product_query=$db->prepare("select DISTINCT bill_no, bill_amt, bill_date from  transaction_mst where transaction_mst.device_id='$d_id'  and bill_date between '$start_date' and '$end_date'");
    ...
    $Product_query=$db->prepare("select DISTINCT bill_no, bill_amt, tax_state, discount, parcel_amt, tax_amt,parcel_amt, bill_date from  transaction_mst where transaction_mst.device_id='$d_id'  and bill_date between '$start_date' and '$end_date' LIMIT $start_from, $limit");  
    $Product_query->execute();
    ?>
    <!DOCTYPE html>
    <html>
