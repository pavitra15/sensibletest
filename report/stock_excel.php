...
// include('../connect.php');
    ...
    $count_query=$db->prepare("select * from product,category_dtl,stock_mst,price_mst where stock_mst.product_id=product.product_id  and product.deviceid='$d_id' and product.product_id= price_mst.product_id and product.product_id=stock_mst.product_id and product.category_id= category_dtl.category_id");
    $count_query->execute();
    $response='{"data":[';
...
?>
    ...
    <script>
        ...
        function go(){
            ...
            excel.generate("Stock_Report.xlsx");
