<?php
    ...
    while($id_data=$id_query->fetch())
    {
        ...
        if($device_count>0)
        {
            $first_date = new DateTime("8 days ago", new DateTimeZone('Asia/Kolkata') );
            $start_report_date=$first_date->format('l jS \of F Y');
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <p>Hi '.$first_name.',</p>
                                                <p> This is weekly Summary report of your following devices.</p>
                                                <p>
                                                    From : <span style="color: #a09bb9">'.$start_report_date.'</span>
                                                </p>
                                                <p>
                                                    To : <span style="color: #a09bb9">'.$end_report_date.'</span>
                                                </p>';
            while($deviceid_data=$deviceid_query->fetch())
            {
                $start_date = $first_date->format( 'Y-m-d 00:00:00');
                $end_date = $last_date->format( 'Y-m-d 23:59:59');
